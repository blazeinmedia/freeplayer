<?php
$LOGIN_INFORMATION=array('xxx@gmail.com'=>'khaled','admin'=>'adminpass');
define('USE_USERNAME',true);define('LOGOUT_URL','/test.php');
...
<form action="run.php" target="_blank" method="POST">
